...
namespace Fasetto.Word
{
    ...
    /// </summary>
    public partial class SWAdjustControl : UserControl
    {/// <summary>
     /// This User Control is always linked to the popup component of the ApplicationViewModel
     /// </summary>
        public SWAdjustControl()
        {
            InitializeComponent();


            // Set data context to settings view model
            ViewModelApplication.CurrentPopupViewModel = new SWAdjustViewModel();
            //if (ViewModelApplication.AddElementViewModel == null)
            //    DataContext = new HierarchyElementViewModel();
            //else
            DataContext = (SWAdjustViewModel)ViewModelApplication.CurrentPopupViewModel;
