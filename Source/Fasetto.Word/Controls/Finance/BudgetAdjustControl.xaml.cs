    ...
    {/// <summary>
     ...
     /// </summary>
        public BudgetAdjustControl()
        {
            ...
            //else
            DataContext = (BudgetAdjustViewModel)ViewModelApplication.CurrentPopupViewModel;
