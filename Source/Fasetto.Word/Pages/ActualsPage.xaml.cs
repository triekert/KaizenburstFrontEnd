...
namespace Fasetto.Word
{
    ...
    /// </summary>
    public partial class ActualsPage : BasePage<ActualsPageViewModel>
    {
        #region Constructor
        ...
        public ActualsPage(ActualsPageViewModel specificViewModel) : base(specificViewModel)
        {
            InitializeComponent();
        }
