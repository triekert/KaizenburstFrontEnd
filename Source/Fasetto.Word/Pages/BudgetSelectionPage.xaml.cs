...
namespace Fasetto.Word
{
    ...
    /// </summary>
    public partial class BudgetSelectionPage : BasePage<BudgetSelectionPageViewModel>
    {
        #region Constructor
        ...
        /// Default constructor
        /// </summary>
        public BudgetSelectionPage() : base()
        {
            //InitializeComponent();
        ...
        public BudgetSelectionPage(BudgetSelectionPageViewModel specificViewModel) : base(specificViewModel)
        {
            ViewModelApplication.CurrentPageViewModel = ViewModelApplication.CurrentPageViewModel;
