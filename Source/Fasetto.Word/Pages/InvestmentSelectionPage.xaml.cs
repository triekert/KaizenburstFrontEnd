...
namespace Fasetto.Word
{
    ...
    /// </summary>
    public partial class InvestmentSelectionPage : BasePage<InvestmentSelectionPageViewModel>
    {
        #region Constructor
        ...
        /// Default constructor
        /// </summary>
        public InvestmentSelectionPage() : base()
        {
            //InitializeComponent();
        ...
        public InvestmentSelectionPage(InvestmentSelectionPageViewModel specificViewModel) : base(specificViewModel)
        {
            ViewModelApplication.CurrentPageViewModel = ViewModelApplication.CurrentPageViewModel;
