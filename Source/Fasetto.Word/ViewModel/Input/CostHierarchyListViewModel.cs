...
namespace Fasetto.Word
{
    ...
    /// </summary>
    public class CostHierarchyListViewModel : BaseViewModel

    {
        ...
        /// </summary>
        public ObservableCollection<CostHierarchyViewModel> CostHierarchyList{ get; set; }

        /// <summary>
        /// The selected Billing Period view model
        /// </summary>
        public CostHierarchyViewModel MSelectedCostHierarchy { get; set; }
        ...
        public CostHierarchyViewModel mCHVM;
        public ParameterGenericRootApiModel mRequest;
        ...
        /// from persistent s
        public CostHierarchyListViewModel(string client)
        {
            #region Build HierarchyViewCollection
            CostHierarchyList = new ObservableCollection<CostHierarchyViewModel> {

             new CostHierarchyViewModel
            {

                ShortName = "Loading Cost Hierarchy options for Client...Please be patient",
                KCategoryID = "Test1",
            ...
            mRequest = new ParameterGenericRootApiModel
            {
                ClientID = client,
        ...
        /// </summary>
        /// <returns></returns>
        public async Task CostHierarchyAsync()
        {
            await RunCommandAsync(() => BulkReconBuildIsRunning, async () =>
            {
                ...
                if (string.IsNullOrEmpty(token))
                    ...
                    return;
                var result = await WebRequests.PostAsync<ApiResponse<CostHierarchyResultListApiModel>>(
                // Set URL
                    RouteHelpers.GetAbsoluteRoute(ApiRoutes.ReturnRootPerClientAndType),
                    mRequest,
                    bearerToken: token);

                // If the response has an error...
                if (await result.HandleErrorIfFailedAsync("Cost Hierarchy List retrieval Failed"))
                    // We are done
                    return;
                ...
                try
                {
                    ...
                    var mCHVM = new CostHierarchyViewModel
        ...
        public IEnumerator<CostHierarchyListViewModel> MatchingCategoryEnumerator { get; private set; }
        ...
        public IEnumerator<CostHierarchyViewModel> MatchingKCategoryEnumerator { get; private set; }
