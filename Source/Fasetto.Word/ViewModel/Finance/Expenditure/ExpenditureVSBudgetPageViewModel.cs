...
namespace Fasetto.Word
{
    ...
    /// </summary>
    public class ExpenditureVSBudgetPageViewModel : BaseViewModel
    {
       ...
       /// <summary>
        ...
        public void Reconcile()
        {
            ...
            ViewModelApplication.FClientID = ((HierarchyItemSelectionViewModel)((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).Client).EditedKid;
            ViewModelApplication.ClientShortName = ((HierarchyItemSelectionViewModel)((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).Client).EditedName;
            ViewModelApplication.FCostHierarchyID = ((HierarchyItemSelectionViewModel)((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).CostHierarchy).EditedKid;
            ViewModelApplication.CostHierarchyShortName = ((HierarchyItemSelectionViewModel)((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).CostHierarchy).EditedName;
            ...
            var Test3 = ((HierarchyItemSelectionViewModel)((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).CostHierarchy).EditedKid;
            if (Test3 == null)
            {
        ...
        public async Task<bool> SetCostHierarchySelectionAsync()
        {
            ...
            return await RunCommandAsync(() => SetHierarchyCompleted, async () =>
            {
                ...
                //((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).CostHierarchy.ClientID = ((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).Client.EditedKid;
                //((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).CostHierarchy.RootID = ((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).Client.RootID;
        ...
        public async Task<bool> SetClientHierarchySelectionAsync()
        {
            ...
            return await RunCommandAsync(() => SetHierarchyCompleted, async () =>
            {
                ...
                ViewModelApplication.CurrentControlViewModel = ((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).Client;
                HierarchyParam = new ParameterHierarchyItemSelectApiModel
                {
        ...
        public async Task<bool> InitialiseCostHAsync()
        {
            ...
            //    ((ExpenditureVSBudgetPageViewModel)ViewModelApplication.CurrentPageViewModel).CostHierarchy = new CostHierarchyListViewModel(Root.EditedKid)
            //    {
