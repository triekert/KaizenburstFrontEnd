...
namespace Fasetto.Word
{
...

    {
        ...
        public readonly CategorySearchViewModel mParent;
        private readonly CategorySearchDataModel mElement;
        public ObservableCollection<CategorySearchViewModel> mChildren;
        ...
        /// </summary>
        public string DescrLookup => mElement.DescrLookup;
        /// <summary>
        ///Proportion of transaction allocated to costCategory
        /// </summary>
        public int Proportion => mElement.Proportion;
        /// <summary>
        ...
        ///Unique Identifier
        /// </summary>
        public string KCatSrchID  => mElement.KCatSrchID;

        /// <summary>
        /// The linked category for the expenses
        /// </summary>
        public string FFinCategoryID => mElement.FFinCategoryID;


        /// <summary>
        /// The linked category for the expenses
        /// </summary>
        public string FPartyID => mElement.FPartyID;
        ...
        /// </summary>
        /// 
        public int Index => mElement.Index;

        /// <summary>
        ///Fixed portion of transaction allocated to this category
        /// </summary>
        public decimal FixedAmouunt => mElement.FixedAmount;
        /// <summary>
        ...
        public CategorySearchViewModel(CategorySearchDataModel element)

                 : this(element, null)
        {
        }

        private CategorySearchViewModel(CategorySearchDataModel element, CategorySearchViewModel parent)
        {
            mElement = element;
            mParent = parent;
            ...
            //mChildren = new ObservableCollection<CategorySearchViewModel>(
            //        (from child in mElement.Children orderby(mElement.ShortName)
            //         select new CategorySearchViewModel(child, this))
            //         .ToList());
            //}
            //catch (Exception ex)
            //{
