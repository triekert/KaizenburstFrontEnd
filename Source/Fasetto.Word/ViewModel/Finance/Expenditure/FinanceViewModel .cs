...
namespace Fasetto.Word
{
...

    {
        ...
        public readonly FinanceViewModel mParent;
        private readonly HierarchyDataModel mElement;
        public ObservableCollection<FinanceViewModel> mChildren;
        ...
        /// </summary>
        public ObservableCollection<FinanceViewModel> Children => mChildren;
        ...
        public FinanceViewModel(HierarchyDataModel element)

                 : this(element, null)
        {
        }

        private FinanceViewModel(HierarchyDataModel element, FinanceViewModel parent)
        {
            mElement = element;
            mParent = parent;
            ...
            mChildren = new ObservableCollection<FinanceViewModel>(
                    (from child in mElement.Children orderby(mElement.ShortName)
                     select new FinanceViewModel(child, this))
                     .ToList());
            }
            catch (Exception ex)
            {
        ...
        ////public FinanceViewModel Parent => mParent;
        ...
        //{
        //    // Clear Items
        //    Children = new ObservableCollection<FinanceViewModel>();
        ...
        private void Expand()
        {
            ...
            //    return;
            //Children = new ObservableCollection<FinanceViewModel>(
            //    children.Select(child => new FinanceViewModel(child.ShortName, child.Description, child.KCategoryID, mHDML)));
        }
