...
namespace Fasetto.Word
{
    ...
    /// </summary>
    public class FinanceSelectionViewModel : BaseViewModel

        {
            //#region Data

            public readonly FinanceSelectionViewModel mParent;
            private readonly ExpenditureDataModel mElement;
            public ObservableCollection<FinanceSelectionViewModel> mChildren;
            ...
            /// </summary>
            public ObservableCollection<FinanceSelectionViewModel> Children => mChildren;
            ...
            public FinanceSelectionViewModel()

            {

            }
            public FinanceSelectionViewModel(ExpenditureDataModel element)

                     : this(element, null)
            {
            }

            private FinanceSelectionViewModel(ExpenditureDataModel element, FinanceSelectionViewModel parent)
            {
                mElement = element;
                mParent = parent;
                ...
                try
                {
                    ...
                    mChildren = new ObservableCollection<FinanceSelectionViewModel>(
                            (from child in mElement.Children
                             orderby (mElement.ShortName)
                             select new FinanceSelectionViewModel(child, this))
                             .ToList());
                }
                catch (Exception ex)
                {
